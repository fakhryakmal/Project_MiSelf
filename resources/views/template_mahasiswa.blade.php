        ...
        <div class="polman-nav-static-top">
            ...
            <div class="polman-menu" style="margin-right: 50px;">
                <nav class="nav justify-content-end" style="padding-top: 5px;">
                    <b id="username1" style="position: absolute;">{{ strtoupper(session('user_name')) }} (MAHASISWA)</b>
    ...
    <div class="polman-nav-static-right collapse scrollstyle" id="menu">
        <div id="accordions" role="tablist" aria-multiselectable="true">
            <div class="list-group">
                ...
                <a href="{{ route('Dashboard.dashboard_Mahasiswa') }}" class='list-group-item list-group-item-action ' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                    <i class='fa fa-home fa-lg fa-pull-left'></i>Dashboard
                </a>

                <a href="{{ route('Konseling_NonAkademik.Data_Pengajuan') }}" class='list-group-item list-group-item-action ' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                ...
                <div id='menu1' class='collapse' role='tabpanel'>
                    <a href="{{ route('Jadwal_Konseling.KonfirmasiJadwal') }}" class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                        <i class="fas fa-minus"></i> Konfirmasi Jadwal
                    </a>
                    <a href="{{ route('Jadwal_Konseling.JadwalMahasiswa') }}" class='list-group-item list-group-item-action' style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                        <i class="fas fa-minus"></i> Lihat Jadwal
                    </a>
                </div>
              
                <a href="{{ route('Riwayat_Konseling.RiwayatMahasiswa') }}" class='list-group-item list-group-item-action ' style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>

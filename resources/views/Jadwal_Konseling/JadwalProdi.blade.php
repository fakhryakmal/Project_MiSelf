...
<section class="section" style="border-bottom: 1px solid #ccc;">
    <h6><span style="color: blue;">MI-SELF</span> / Jadwal Konseling</h6>
</section>
<br/>
                ...
                <tbody>
                    @foreach ($jadwal as $catatan)
                        <tr>
                            ...
                            <td style="text-align: center;">{{ date('d-m-Y', strtotime($catatan->tanggal_konseling)) }}</td>
                                            ...
                                            <div class="modal-body">
                                                <table class="table" style="text-align: left;">
                                                    <tr>
                                                        ...
                                                        <td>JDL-{{ $catatan->id_konseling }}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> {{ date('d-m-Y', strtotime($catatan->tanggal_konseling)) }}</td>
                                                    </tr>
                                                    <tr>
